...
<body>
    ...
    <?php needLogin();?>
    <?php if(isset($_GET['id'])) needRole("admin", $conn); ?>
    <div class="container" id="container" style="padding-top: 88px">
        <form method="POST"
            action="../pages/forum_save.php<?php if (isset($_GET['id'])) echo '?topic=' . $_GET['id']; else echo "?topic=new"; ?><?php if (isset($_GET['comment'])) $comment = $_GET['comment']; else $comment = 1; echo '&comment=' . $comment; ?>"
